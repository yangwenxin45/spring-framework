...
/**
 * Implements the {@link org.springframework.web.servlet.mvc.condition.RequestCondition} contract by delegating to multiple
...
/**
 * 责任链模式，这种模式在SpringMVC中非常常见，类名一般是CompositeXXX或者XXXComposite的形式
 *
 * @author yangwenxin
 * @date 2023-07-26 09:43
 */
