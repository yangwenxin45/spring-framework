 ...
 * 所承载信息分为两类：
 * 1. 以org.springframework.aop.framework.ProxyConfig为统领，记载生成代理对象的必要信息
 * 2. 以org.springframework.aop.framework.Advised为旗帜，承载生成代理对象所需要的必要信息
 */
public class AdvisedSupport extends ProxyConfig implements Advised {
     ...
     */
    // 如果要采用基于接口的代理方式，那么需要通过该属性配置相应的接口类型
