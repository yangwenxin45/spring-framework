...
/**
 * DelegatingTransactionAttribute是抽象类，它存在的目的就是被子类化
 * DelegatingTransactionAttribute会将所有方法调用委派给另一个具体的TransactionAttribute实现类，比如DefaultTransactionAttribute或者RuleBasedTransactionAttribute
 */
