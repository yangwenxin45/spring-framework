 ...
 * implements the {@link org.springframework.transaction.support.TransactionCallback} interface. This template handles
...
/**
 * TransactionTemplate是Spring提供的进行编程事务管理的模板方法类
 * TransactionTemplate对与PlatformTransactionManager相关的事务界定操作以及相关的异常处理进行了模板化封装，
 * 开发人员更多地关注于通过相应的Callback接口提供具体的事务界定内容即可
 */
