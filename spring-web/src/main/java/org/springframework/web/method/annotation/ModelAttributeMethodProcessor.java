...
/**
 * 解析注解了@ModelAttribute的参数，如果其中的annotationNotRequired属性为true还没有解析没有注解的非通用类型的参数
 * RequestParamMethodArgumentResolver解析没有注解的通用类型的参数
 * <p>
 * 处理注解了@ModelAttribute类型的返回值，如果annotationNotRequired为true还可以处理没有注解的非通用类型的返回值
 *
 * @author yangwenxin
 * @date 2023-07-27 11:42
 */
