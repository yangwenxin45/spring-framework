...
/**
 * Spring's default implementation of the {@link org.springframework.beans.factory.config.ConfigurableListableBeanFactory}
 * and {@link org.springframework.beans.factory.support.BeanDefinitionRegistry} interfaces: a full-fledged bean factory
...
public class DefaultListableBeanFactory extends AbstractAutowireCapableBeanFactory
    ...
    // 所有Bean注册后都会放入到这个beanDefinitionMap中
    ...
    public void preInstantiateSingletons() throws BeansException {
        ...
        // 如果bean实现了SmartInitializingSingleton接口，那么在这里得到回调
        for (String beanName : beanNames) {
    ...
    public void registerBeanDefinition(String beanName, BeanDefinition beanDefinition)
        ...
        if (existingDefinition != null) {
            // 如果对应的beanName已经注册并且配置了bean不允许被覆盖，则抛出异常
    ...
    public Object resolveDependency(DependencyDescriptor descriptor, @Nullable String requestingBeanName,
        ...
        if (Optional.class == descriptor.getDependencyType()) {
            ...
            // ObjectFactory或者ObjectProvider类注入的特殊处理
