 ...
 * {@link org.springframework.beans.factory.config.InstantiationAwareBeanPostProcessorAdapter} in order to be shielded
...
/**
 * 当SpringIOC容器检测到有InstantiationBeanPostProcessor类型的BeanPostProcessor的时候，
 * 会直接通过InstantiationAwareBeanPostProcessor中的逻辑构造对象返回，而不会走正常的对象实例化流程，也就是"短路"
